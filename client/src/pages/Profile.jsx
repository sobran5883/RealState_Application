  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form className="flex flex-col gap-4">
        ...
        <img onClick={()=>fileRef.current.click()} src={formData.avatar || currentUser.avatar} alt="profile" className="rounded-full h-24 w-24 object-cover cursor-pointer self-center mt-2" src={currentUser.avatar} alt="" />
